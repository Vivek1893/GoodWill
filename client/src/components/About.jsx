      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 items-center">
        ...
        >
          <motion.img
            ...
            alt="Structural glazing facade work by The Goodwill Facades - Modern architectural facade solutions"
            loading="lazy"
            width="600"
            height="450"
          ...
          <motion.img
            ...
            alt="Modern facade construction work - The Goodwill Facades architectural projects"
            loading="lazy"
            width="320"
            height="300"
